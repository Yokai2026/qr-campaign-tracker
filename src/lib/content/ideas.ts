...
ANTI-WIEDERHOLUNG (zusätzlich):
  ...
  - Wenn Pillar "KI-Recht & Risiken" (ai_risk): variiere — EU AI Act 2026 für Marketer /
    DSGVO bei ChatGPT-Kundendaten / Urheberrecht Midjourney+Sora / Haftung bei n8n-Agent-
    Fehler / Hallucinations-Folgen-Cases / AI-Agent-Security-Risiken / Microsoft-OpenAI-
    Anthropic-Datenpolicy / Deepfakes im Marketing / Sichere AI-Workflows mit Self-Host /
    Transparenz-Pflicht für AI-Content / EU-LLMs vs US-Cloud / Bußgeld-Cases mit KI-
    Bezug / Mythen vs Realität / ChatGPT-Enterprise-vs-Privat / Kundendaten-Anonymisierung
    vor LLM-Input / AI-Audit für KMU. TONALITÄT: locker + intelligent + ehrlich, NIE
    panisch. Schreibe wie David (täglich KI nutzt) — als smartes Risikomanagement, nicht
    als Anwaltstext. Reale Beispiele bevorzugen, keine theoretischen Was-wäre-wenn.
...
──── Typ U: Risk-Reveal-Opener (NEU 2026 — KI-Recht/Risiken) ────
Konkretes Risiko in den ersten 2 Sätzen — OHNE Panik, mit smartem Insight.
Locker, intelligent, ehrlich. NICHT wie ein Anwaltstext.
Beispiele:
  "Wer ChatGPT mit Kundendaten füttert, schenkt OpenAI mehr als er denkt. Hier ist wie ich das löse — ohne KI-Verzicht."
  "Midjourney-Bilder gehören dir nicht automatisch. Vor 3 Wochen hat ein Designer das auf die harte Tour gelernt."
  "Der EU AI Act ist ab 02/2026 Pflicht. Für Marketer bedeutet das eine Sache, über die niemand spricht."

──── Typ V: Hallucination-Story-Opener ────
Konkrete Story über AI-Fehler (mit Lerneffekt, nicht Panikmache).
Beispiele:
  "ChatGPT hat letzte Woche einen Pricing-Fehler in meinem Angebot eingebaut. 4.800€ Differenz. Niemand hätte es bemerkt — bis ich es selbst gegen-gerechnet habe."
  "Claude hat einen Vertrags-Paragraphen frei erfunden. Sah perfekt aus. War komplett falsch. Hier ist mein neuer Check-Prozess."

──── Typ W: Compliance-Aha-Opener ────
Konkreter Compliance-Trick + sofortige Anwendbarkeit (locker, kein Lehrbuch).
Beispiele:
  "Ein Wort im ChatGPT-System-Prompt macht den Unterschied zwischen DSGVO-Verstoß und sauberer Nutzung. Hier ist welches."
  "Wenn du n8n self-hostest, hast du 80% der AI-Compliance-Themen gelöst — viele wissen das nicht."
  "Es gibt einen Trick, wie du Kundendaten an ChatGPT übergeben kannst, ohne dass sie real-data sind. Schon 2 Mio Marketer nutzen ihn — auch wenn sie's nicht so nennen."
...
PFLICHT-CHECK nach Zeile 1+2: Steht in den ersten 2 Sätzen mindestens EINS davon?
  ...
  □ Risk-Reveal mit konkretem Beispiel — OHNE Panik (Typ U)
  □ Hallucination-Story mit Lerneffekt (Typ V)
  □ Compliance-Aha-Trick — locker, kein Lehrbuch (Typ W)
...
- KI-Recht & Risiken (ai_risk):
                   K6 (Daten als physisches Objekt — Kundendaten als Aktenkoffer,
                   AI-Output als zerknittertes Papier mit "Generated by AI"-Stempel,
                   Hallucination als Spiegelbild das verzerrt zeigt) ODER K3
                   (Compliance-Symbol in absurder Umgebung — Bundesadler-Stempel auf
                   ChatGPT-Eingabefenster, EU-Sterne-Kreis um Server-Rack) ODER K4
                   (Split-Screen: AI-Tool ohne Schutz / AI-Tool mit Schutz) ODER K2
                   (Risk-Reveal: Daten-Schraffur die "leakt"). PFLICHT: KEIN
                   Panik-Bild (keine Roboter mit roten Augen, keine Skull-Symbole).
                   Stattdessen: smart, ruhig, technisch-präzise, EU-flagged-Stil.
